    ...
    <>
      <div className="fixed top-0 left-0 w-full h-full flex justify-center  items-center  bgGradient">
        <div className="w-[70%] h-[70vh] rounded-2xl flex justify-center items-center">
          {/* section 1 */}
          <div className="glowBlock w-[60%] h-full rounded-2xl p-[0.2rem] pr-0">
          ...
          <div className="w-[40%] h-full rounded-2xl rounded-l-none  flex">
            ...
            <div className="w-[75%] h-full bg-white flex flex-col p-5 py-8">
              <div className="w-full flex flex-col gap-2">
                <div className="w-full flex justify-between">
                  ...
                  <div className="flex flex-col items-end">
                    <p className="text-lg poppins select-none">ADMITS</p>
                    <p className="font-bold  text-4xl poppins select-none">01</p>
                  </div>
                </div>
              ...
              <div className="w-full overflow-hidden mb-3">
                <input
                  className="select-none border-none outline-none text-xl bg-[#F2F5FE] rounded-md px-3 pr-10 py-1   "
                  type="text"
                  placeholder="Email"
                />
              </div>
              ...
              <div className="px-3 my-2">
                ...
                <p className="select-none text-gray-400 text-xs">{new Date().toLocaleString()}</p>
              </div>
              <div className="w-full h-[10%] mt-5">
                <FancyButton text1="Create" text2="Journey" />
              </div>
              <p className="text-sm w-full text-center mt-2 select-none">
                Already have an account ? <Link className="text-violet-500 hover:underline underline-offset-2 cursor-pointer" to="/login">Login</Link>
              </p>
            </div>
            {/* Ticket styles */}
