    ...
    <>
      ...
      >
        <form
          ...
          } rounded-xl flex items-center p-5 pt-7 flex-col shadow-xl `}
        >
          <h1
          ...
          <p
            className={`select-none  mt-3 md:w-[80%] text-center transition-all ${
          ...
          <div className="w-full relative">
            <input
              ...
              } outline-none rounded-md w-full pr-3 p-4`}
              type="text"
              id="Email"
              {...register("email", {
