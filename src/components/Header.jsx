    ...
    <>
      <div className="flex w-full justify-between items-center font-extrabold mb-2 pr-3 max-sm:pr-0">
        ...
        <div className="flex gap-2  justify-center items-center font-normal ">
          ...
          >
            <div className={`h-[95%] rounded-full w-[95%] ${mode?"bg-[#1c1c1c]":"bg-gray-200"} flex justify-center items-center transition-all`}>
              <i className="ri-user-line font-normal text-2xl max-sm:text-lg hover:text-white"></i>
